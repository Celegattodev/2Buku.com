...
export declare namespace contactcenterinsights_v1 {
    ...
    export class Resource$Projects$Locations {
         ...
         */
        getEncryptionSpec(params: Params$Resource$Projects$Locations$Getencryptionspec, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getEncryptionSpec(params?: Params$Resource$Projects$Locations$Getencryptionspec, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudContactcenterinsightsV1EncryptionSpec>;
    ...
    export class Resource$Projects$Locations$Encryptionspec {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        initialize(params: Params$Resource$Projects$Locations$Encryptionspec$Initialize, options: StreamMethodOptions): GaxiosPromise<Readable>;
        initialize(params?: Params$Resource$Projects$Locations$Encryptionspec$Initialize, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
    ...
    export class Resource$Projects$Locations$Issuemodels {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        export(params: Params$Resource$Projects$Locations$Issuemodels$Export, options: StreamMethodOptions): GaxiosPromise<Readable>;
        export(params?: Params$Resource$Projects$Locations$Issuemodels$Export, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        import(params: Params$Resource$Projects$Locations$Issuemodels$Import, options: StreamMethodOptions): GaxiosPromise<Readable>;
        import(params?: Params$Resource$Projects$Locations$Issuemodels$Import, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
