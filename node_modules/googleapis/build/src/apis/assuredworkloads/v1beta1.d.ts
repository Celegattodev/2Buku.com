...
export declare namespace assuredworkloads_v1beta1 {
    ...
    export class Resource$Organizations$Locations$Workloads {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        enableComplianceUpdates(params: Params$Resource$Organizations$Locations$Workloads$Enablecomplianceupdates, options: StreamMethodOptions): GaxiosPromise<Readable>;
        enableComplianceUpdates(params?: Params$Resource$Organizations$Locations$Workloads$Enablecomplianceupdates, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudAssuredworkloadsV1beta1EnableComplianceUpdatesResponse>;
