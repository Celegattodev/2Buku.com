...
export declare namespace games_v1 {
    ...
    export class Resource$Accesstokens {
         ...
         */
        generatePlayGroupingApiToken(params: Params$Resource$Accesstokens$Generateplaygroupingapitoken, options: StreamMethodOptions): GaxiosPromise<Readable>;
        generatePlayGroupingApiToken(params?: Params$Resource$Accesstokens$Generateplaygroupingapitoken, options?: MethodOptions): GaxiosPromise<Schema$GeneratePlayGroupingApiTokenResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateRecallPlayGroupingApiToken(params: Params$Resource$Accesstokens$Generaterecallplaygroupingapitoken, options: StreamMethodOptions): GaxiosPromise<Readable>;
        generateRecallPlayGroupingApiToken(params?: Params$Resource$Accesstokens$Generaterecallplaygroupingapitoken, options?: MethodOptions): GaxiosPromise<Schema$GenerateRecallPlayGroupingApiTokenResponse>;
    ...
    export class Resource$Recall {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        gamesPlayerTokens(params: Params$Resource$Recall$Gamesplayertokens, options: StreamMethodOptions): GaxiosPromise<Readable>;
        gamesPlayerTokens(params?: Params$Resource$Recall$Gamesplayertokens, options?: MethodOptions): GaxiosPromise<Schema$RetrieveGamesPlayerTokensResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        lastTokenFromAllDeveloperGames(params: Params$Resource$Recall$Lasttokenfromalldevelopergames, options: StreamMethodOptions): GaxiosPromise<Readable>;
        lastTokenFromAllDeveloperGames(params?: Params$Resource$Recall$Lasttokenfromalldevelopergames, options?: MethodOptions): GaxiosPromise<Schema$RetrieveDeveloperGamesLastPlayerTokenResponse>;
