...
export declare namespace containeranalysis_v1beta1 {
    ...
    export class Resource$Projects$Locations$Resources {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generatePackagesSummary(params: Params$Resource$Projects$Locations$Resources$Generatepackagessummary, options: StreamMethodOptions): GaxiosPromise<Readable>;
        generatePackagesSummary(params?: Params$Resource$Projects$Locations$Resources$Generatepackagessummary, options?: MethodOptions): GaxiosPromise<Schema$PackagesSummaryResponse>;
